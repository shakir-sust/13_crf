...
The power of random forests come from **two random processes**:  
  ...
  - Random selection of a subset of predictor variables (i.e., columns) at each split. [Random selection of a subset of predictor variables/columns at each split]  
